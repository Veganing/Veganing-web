...
export default function CartSection({ navigate }) {
  const [cartItems, setCartItems] = useState([
    ...
    },
    {
      ...
      quantity: 1,
      image:
        "https://images.unsplash.com/photo-1582169296194-e4d644c48063?w=200&h=200&fit=crop",
      category: "반찬",
    },
    {
      id: 4,
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>{cartItems.length}개의 상품</CardDescription>
          </div>
          {cartItems.length > 0 && (
      ...
      <CardContent>
        {cartItems.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h3 className="text-xl text-gray-800 mb-2">장바구니가 비어있습니다</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="mt-8 p-6 rounded-2xl bg-gradient-to-br from-teal-50 to-emerald-50 border-2 border-teal-200">
              <div className="space-y-3 mb-6">
                ...
                <div className="flex items-center justify-between text-gray-600">
                  <span>배송비</span>
                  <span>{getTotalPrice() >= 30000 ? "무료" : "3,000원"}</span>
                </div>
